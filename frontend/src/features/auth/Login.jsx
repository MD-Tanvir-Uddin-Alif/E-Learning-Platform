...
const Login = () => {
  return (
    ...
    <style>{`
      ...
      .floating-input:not(:placeholder-shown) + label, .floating-input:focus + label { top:0; transform:translateY(-50%) scale(0.85); color:#ff6d1f; }
        ...
        <div className="w-full max-w-[480px] bg-[#FAF3E1] border border-[#F5E7C6] rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 md:p-12">
          ...
          <form action="#" className="space-y-6">
            ...
            <div className="relative">
              <input id="email" type="email" placeholder=" " className="floating-input block px-4 pb-2.5 pt-5 w-full text-base text-[#222222] bg-[#FAF3E1] rounded-lg border border-[#F5E7C6] appearance-none focus:outline-none focus:ring-0 focus:border-[#ff6d1f] peer transition-colors h-14" />
              <label htmlFor="email" className="absolute text-base text-gray-500 duration-300 transform -translate-y-4 scale-75 top-0 z-10 origin-[0] left-4 peer-focus:text-[#ff6d1f] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 bg-[#FAF3E1] px-1 pointer-events-none">
                Email Address
              </label>
            </div>
            ...
            {/* Password */}
            <div className="relative">
              <input id="password" type="password" placeholder=" " className="floating-input block px-4 pb-2.5 pt-5 w-full text-base text-[#222222] bg-[#FAF3E1] rounded-lg border border-[#F5E7C6] appearance-none focus:outline-none focus:ring-0 focus:border-[#ff6d1f] peer transition-colors h-14 pr-12" />
              <label htmlFor="password" className="absolute text-base text-gray-500 duration-300 transform -translate-y-4 scale-75 top-0 z-10 origin-[0] left-4 peer-focus:text-[#ff6d1f] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 bg-[#FAF3E1] px-1 pointer-events-none">
                Password
              </label>
              <button type="button" className="absolute right-4 top-1/2 -translate-y-1/2 text-[#222222] hover:text-[#ff6d1f] transition-colors focus:outline-none">
            ...
            {/* Submit */}
            <button type="button" className="w-full h-12 bg-[#ff6d1f] text-[#FAF3E1] rounded-lg font-bold text-base hover:bg-[#222222] hover:text-white transition-all duration-300 shadow-sm flex items-center justify-center gap-2 group">
              <span>Sign in</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 h-12 rounded-lg bg-[#F5E7C6]/50 hover:bg-[#F5E7C6] border border-transparent hover:border-[#F5E7C6] transition-colors text-[#222222] font-medium">
            ...
            <button className="flex items-center justify-center gap-2 h-12 rounded-lg bg-[#F5E7C6]/50 hover:bg-[#F5E7C6] border border-transparent hover:border-[#F5E7C6] transition-colors text-[#222222] font-medium">
              <svg className="w-5 h-5" viewBox="0 0 23 23"><path d="M1 1h10v10H1z" fill="#f35325"/><path d="M12 1h10v10H12z" fill="#81bc06"/><path d="M1 12h10v10H1z" fill="#05a6f0"/><path d="M12 12h10v10H12z" fill="#ffba08"/></svg>
              Microsoft
            </button>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-[#222222] text-sm">
              ...
              <Link to="/registration" className="text-[#ff6d1f] font-bold hover:underline ml-1">Register now</Link>
            </p>
          </div>
        </div>
      </main>
